...
# -*- coding: utf-8 -*-
#
# jupyter_cvlabelling_widget documentation build configuration file
#
...
project = 'jupyter_cvlabelling_widget'
copyright = '2019, Damien Picard'
...
_version_py = os.path.join(repo, 'jupyter_cvlabelling_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_cvlabelling_widgetdoc'
...
latex_documents = [
    (master_doc, 'jupyter_cvlabelling_widget.tex', 'jupyter_cvlabelling_widget Documentation',
     'Damien Picard', 'manual'),
]
...
man_pages = [
    (master_doc,
    'jupyter_cvlabelling_widget',
    'jupyter_cvlabelling_widget Documentation',
     [author], 1)
]
